...
var AppComponent = (function () {
    ...
    AppComponent.prototype.IwantToEditLiturgySchedule = function (myModal) {
        ...
        this.http.post('/api/LiturgySchedule/EditLiturgySchedule', this.SCHEDULES).subscribe(function (Noerror) { return myModal.close(); }, function (error) { return _this.errorMessage = "Password is incorrect!"; });
        debugger;
    };
    return AppComponent;
}());
